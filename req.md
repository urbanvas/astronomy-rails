...
planets - size, type(gas, rocky), life?(boolean),friendly?, dominant species name(humans, gazorpazorp, clock people)

belongs to solar systems
belongs to users

(solar) systems, planet#,size(no need to have 2 sizes and make it more complicated), star(type or size, eg. red giant or 50k miles wide, decide in the future?)
...
galaxies - color, type(milky way, spiral, elpicitcal)

has many planets thru solar systems
has many solar systmes
belongs to user


users - password digest, email, username
...
-
the readme uses filtering dropdown menu, like filter between largest galxies, or most planets, like a date ordered picker in a dropdown (this month, today, last week, etc)
